...
app.get('/testhtml', function(req, res, next) {
  fs.createReadStream('/home/mawni/code/mytest/sample-tester/views/index-html.html', 'utf8')
    .pipe(res);
});

app.get('/testejs', function(req, res, next) {
  fs.createReadStream('/home/mawni/code/mytest/sample-tester/views/index-ejs.ejs', 'utf8')
    .pipe(res);
});
